...
import com.gamingisland.vitaldetector.ml.MelModel;
...
public class skin_can_detect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skin_can_detect);
