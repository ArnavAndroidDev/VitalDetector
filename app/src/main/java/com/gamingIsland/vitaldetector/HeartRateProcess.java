...
public class HeartRateProcess extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(HeartRateProcess.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    private final PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            ++counter; //countes number of fjhrames in 30 seconds
            ...
            if (totalTimeInSecs >= 30) { //when 30 seconds of measuring passes do the following " we chose 30 seconds to take half sample since 60 seconds is normally a full sample of the heart beat
                ...
                double samplingFreq = (counter / totalTimeInSecs); //calculating the sampling frequency
