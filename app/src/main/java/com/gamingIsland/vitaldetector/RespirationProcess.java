...
public class RespirationProcess extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(RespirationProcess.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(RespirationProcess.this, MainActivity.class);
        startActivity(i);
        finish();
    }
}