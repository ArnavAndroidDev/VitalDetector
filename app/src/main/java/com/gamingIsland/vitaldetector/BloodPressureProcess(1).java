...
public class BloodPressureProcess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preview = findViewById(R.id.previewbp);
    ...
    public void onResume() {
        super.onResume();
        wakeLock.acquire();
        if (ContextCompat.checkSelfPermission(BloodPressureProcess.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(BloodPressureProcess.this, new String[]{
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(BloodPressureProcess.this, vitals.class);
        startActivity(i);
        finish();
    }
