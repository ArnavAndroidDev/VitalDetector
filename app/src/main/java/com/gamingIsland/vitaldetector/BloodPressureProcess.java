...
public class BloodPressureProcess extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(BloodPressureProcess.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(BloodPressureProcess.this, MainActivity.class);
        startActivity(i);
        finish();
    }
